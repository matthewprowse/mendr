...
YOUR ONLY JOB: write the prose fields (thought, diagnosis, message, action_required, image_descriptions).
...
${classification.rejected || classification.unserviced
    ? 'Because rejected or unserviced is true: keep message warm and helpful. Explain what Menda does offer.'
    : ''}
