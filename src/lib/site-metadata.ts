 ...
 * Everything contractor-related lives under /pro/*.
 *
 *   /                      Home
 ...
 *   /pro           Contractor landing page           (was /pro/join)
 *   /pro/network   Contractor onboarding            (was /pro/onboard)
 *   /pro/[id]      Contractor public profile         (was /pro/[id])
...
// TODO(og-images): design and add real OG share images, then reintroduce the
// `images` blocks in openGraph/twitter metadata (homepage + /pro).
...
/** Build metadata for /pro/[id] — contractor public profile */
