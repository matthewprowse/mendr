...
import { normalizeReviewForDisplay } from '@/lib/review-normalization';
...
const GOOGLE_FIELD_MASK =
    'id,displayName,formattedAddress,rating,userRatingCount,nationalPhoneNumber,websiteUri,location,reviews,regularOpeningHours,currentOpeningHours,photos';
