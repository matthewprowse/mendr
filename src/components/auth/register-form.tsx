...
// Shared registration form used by /auth/register (homeowner) and
// /pro/auth/register (contractor). Brand, routing and signup-metadata
// differences come in as props.
...
export function AuthRegisterForm({
    ...
    defaultNext: string;
    loginPath: string;
    /** Extra fields merged into the signup metadata (e.g. profile_type: 'pro'). */
    extraSignupMetadata?: Record<string, string>;
}) {
        ...
        <FlowTopBar
            ...
            rightSlot={
                <Button asChild variant="ghost" size="sm">
                    <Link href={`${loginPath}${next !== defaultNext ? `?next=${encodeURIComponent(next)}` : ''}`}>
                        Login
                    </Link>
                </Button>
            }
