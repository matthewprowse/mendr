...
- REPORT DEPTH: In the structured 'message' field, teach the user something they could not infer from a one-line label. Prefer mechanism and likely system state (why it happened, what is probably out of balance or failed) over repeating their own description of the symptom.
