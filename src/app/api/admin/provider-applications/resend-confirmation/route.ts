...
export async function POST(req: NextRequest) {
    ...
    const emailProps = { firstName, businessName: (app.business_name as string | null) ?? '' };
    ...
    const result = await sendMendrEmail({
        ...
        component: React.createElement(ContractorApplicationReceivedEmail, emailProps),
        text:      contractorApplicationReceivedText(emailProps.firstName, emailProps.businessName),
    });
