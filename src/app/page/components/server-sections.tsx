        ...
        <section className="bg-foreground py-14 sm:py-20">
            <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
                ...
                <p className="mt-3 text-base text-background sm:text-lg">
                    Mendr gives you a written diagnosis before the first call - so you know what you are dealing with.
                </p>
                <p className="mt-4 text-sm text-background/70">
                    Mendr is a free AI tool that diagnoses home faults from a photo - focused on Cape Town and available
...
export function HomeMarketingCoverageSection() {
    return (
        <section id="coverage" className="scroll-mt-16 py-16 sm:py-20">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto mb-10 max-w-3xl text-center sm:mb-12">
                    <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">Where Mendr Works</h2>
                    <p className="mt-3 text-base text-muted-foreground">
                        Focused on Cape Town and the surrounding metro, available across the Western Cape.
                    </p>
                </div>
                {/* TODO(coverage-map): replace this placeholder with the interactive
                    coverage map once the Google Maps key and coverage API are wired. */}
                <div className="overflow-hidden rounded-xl border border-border/50">
                    <Placeholder
                        label="Coverage map — Cape Town metro and the Western Cape"
