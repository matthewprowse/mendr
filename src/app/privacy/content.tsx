    ...
    return (
        <LegalFlowDocument>
            ...
            <div className="flex flex-col gap-2 rounded-lg border border-input bg-secondary/40 p-4 text-xs sm:text-sm">
                ...
                <p>
                    ...
                    {c.privacyEmail === LEGAL_DETAILS_UNPUBLISHED ? (
                        <>
                            <span className="text-muted-foreground">privacy@mendr.co.za</span>{' '}
                            <span className="italic text-muted-foreground">
            ...
            <p>
                ...
                information when you use Mendr, a South Africa-focused digital service that helps
            ...
            <p>
                ...
                (as defined in POPIA) in respect of personal information processed through Mendr,
                unless we state otherwise (for example, where a processor acts strictly on our
                instructions).
            </p>
            <p>
                Where this policy refers to &quot;we&quot;, &quot;us&quot;, or &quot;Mendr&quot;, it
                means{' '}
                {c.operatorLegalName === LEGAL_DETAILS_UNPUBLISHED ? (
                    <>Mendr (Pty) Ltd.</>
                ) : (
            ...
            <p>
                ...
                (such as a contractor you contact directly outside Mendr), except where we facilitate
            ...
            <p>
                The nature and category of information depend on how you use Mendr. It may include:
            </p>
            <LegalFlowSubsections>
            <LegalFlowSubsection>
            ...
            <ul className="list-disc space-y-2 pl-5 marker:text-muted-foreground">
                <li>
                    ...
                    listings and reviews aggregated from third-party services) shown on Mendr. That
            ...
            <ul className="list-disc space-y-2 pl-5 marker:text-muted-foreground">
                <li>
                    Provide, operate, secure, and improve Mendr (including AI-assisted diagnosis,
            ...
            <p>
                ...
                prevent parts of Mendr from working.
            </p>
            </LegalFlowSection>
            <LegalFlowSection>
            <h2 className="text-lg font-semibold text-foreground">
            ...
            <p>
                Mendr is not directed at children under 18. We do not knowingly collect personal
            ...
            <p>
                ...
                where appropriate (for example, a banner or email). Continued use of Mendr after
