...
import { PREFERRED_CONTACT_OPTIONS, RESPONSE_TIME_OPTIONS, type ContractorType } from './types';
        ...
        <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-6">
                ...
                <SummaryCard title="Business">
                    ...
                    <p className="text-muted-foreground">{`${data.firstName} ${data.surname}`.trim() || '—'}</p>
                ...
                <SummaryCard title="Contact Details">
                    ...
                    <p className="text-muted-foreground">
                        Preferred channel: {optionLabel(PREFERRED_CONTACT_OPTIONS, data.preferredContactChannel)}
                    </p>
                ...
                <SummaryCard title="Service Terms">
                    ...
                    <p className="text-muted-foreground">
                        Typical response time: {optionLabel(RESPONSE_TIME_OPTIONS, data.typicalResponseTime)}
                    </p>
                    <p className="text-muted-foreground">Pricing model: {data.pricingModel || '—'}</p>
                    <p className="text-muted-foreground">
                        Call-out fee: {data.calloutFee ? `R${data.calloutFee}` : '—'}
                    </p>
                </SummaryCard>
