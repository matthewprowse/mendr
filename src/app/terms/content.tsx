    ...
    return (
        <LegalFlowDocument>
            ...
            <p className="text-muted-foreground">
                These Terms of Service (&quot;Terms&quot;) govern your access to and use of Mendr,
            ...
            <p>
                <strong className="font-semibold text-foreground">Important:</strong> Mendr
                        ...
                        <tr className="border-b border-input">
                            ...
                            <td className="px-3 py-2">
                                {c.legalEmail === LEGAL_DETAILS_UNPUBLISHED ? (
                                    <>
                                        <span className="text-muted-foreground">legal@mendr.co.za</span>{' '}
                                        <span className="italic text-muted-foreground">
            ...
            <p>
                Mendr does not perform on-site work, issue compliance certificates, or warrant
            ...
            <ul className="list-disc space-y-2 pl-5 marker:text-muted-foreground">
                ...
                <li>
                    Not rely on Mendr as the sole basis for decisions that could affect health,
