      ...
      <div className="mx-auto max-w-2xl">
        <div className="mb-8 text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Join Western Cape contractors on Scandio Pro. We&apos;re listing and promoting providers for free until September 2026.
          </p>
        </div>
        {signupSuccess ? (
          ...
          <form onSubmit={handleSignup} className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={spendPerMonth || undefined} onValueChange={setSpendPerMonth}>
                  <SelectTrigger id="spend_per_month" className="w-full bg-background">
            ...
            <Button type="submit" size="lg" disabled={signupSubmitting} className="w-full sm:w-auto">
              {signupSubmitting ? 'Submitting…' : 'Register Interest'}
            </Button>
          </form>
        )}
      </div>
